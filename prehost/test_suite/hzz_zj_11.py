...
class hzz_data_add_11(find_html_ele):
    ...
    def test_11_2(self):
        ...
        for a in range(2000000,2000010):
            time.sleep(1)
            super().data_add()
    ...
    def test_11_3(self):
        ...
        super().dwzh_hzz()
        super().change_iframe('核准制业务申报')
        for a in range(2000010,2000020):
            time.sleep(1)
            super().data_add()
            super().first_businesstype('11')
    ...
    def test_11_4(self):
        ...
        super().dwzh_hzz()
        super().change_iframe('核准制业务申报')
        for a in range(2000020,2000030):
            time.sleep(1)
            super().data_add()
            super().first_businesstype('11')
    ...
    def test_11_6(self):
        ...
        super().dwzh_hzz()
        super().change_iframe('核准制业务申报')
        for a in range(2000030,2000040):
            time.sleep(1)
            super().data_add()
            super().first_businesstype('11')
    ...
    def test_11_8(self):
        ...
        super().dwzh_hzz()
        super().change_iframe('核准制业务申报')
        for a in range(2000040,2000050):
            time.sleep(1)
            super().data_add()
            super().first_businesstype('11')
